...
def get_top_ten_sites(user_query):
	...
	warmup_query = "IIT Computer Science Grad School.\n"
...
def main_search(query):
    ...
    # Get the URLs for the user query or an empty list if not found
    user_query_urls = top_sites.get(2, [])
