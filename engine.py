...
parser.add_argument(
    "--initial_url", 
    type=str,
    help="The initial URL to start the crawling process from. For example: 'https://www.cs.IIT.edu/'"
)
parser.add_argument(
    "--number_of_pages", 
    type=int,
...
parser.add_argument(
    "--domain", 
    type=str,
    help="The domain in which crawling should happen. For example: 'IIT.edu'"
)
